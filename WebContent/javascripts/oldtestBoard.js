...
var bonusText1 = new screenElem("#006400", null, 710, 280, 100, 100, true, "", 0, 46, "48px sans-serif", "#FFFFFF");
...
var QList = [
        		 ...
        		 new questions(0, "How useful is scalability?", "Scalability", [5, 6, 7, 8, 9], 
        				 ["5", "4", "3", "2", "1"],
                		 [1, 2, 3, 4, 5, 6, 2, 4, 5, 6, 3, 1, 4, 5, 2, 6, 3, 1, 5, 4, 2, 3, 1, 6, 6, 5, 4, 3, 2, 1, 3, 5, 6, 1, 4, 2]),
        		 new questions(0, "How important is integrability?", "Integrability", [10, 11, 12, 13, 14], 
        				 ["5", "4", "3", "2", "1"],
                		 [1, 2, 3, 4, 5, 6, 2, 4, 5, 6, 3, 1, 4, 5, 2, 6, 3, 1, 5, 4, 2, 3, 1, 6, 6, 5, 4, 3, 2, 1, 3, 5, 6, 1, 4, 2]),
        		 new questions(0, "How important is Availability?", "Availability", [15, 16, 17, 18, 19], 
        				 ["5", "4", "3", "2", "1"], 
                		 [1, 2, 3, 4, 5, 6, 2, 4, 5, 6, 3, 1, 4, 5, 2, 6, 3, 1, 5, 4, 2, 3, 1, 6, 6, 5, 4, 3, 2, 1, 3, 5, 6, 1, 4, 2]),
        		 new questions(0, "How important is Performance?", "Performance", [20, 21, 22, 23, 24], 
        				 ["5", "4", "3", "2", "1"], 
                		 [1, 2, 3, 4, 5, 6, 2, 4, 5, 6, 3, 1, 4, 5, 2, 6, 3, 1, 5, 4, 2, 3, 1, 6, 6, 5, 4, 3, 2, 1, 3, 5, 6, 1, 4, 2]),
        		 new questions(0, "How useful is Maintainability?", "Maintainability", [25, 26, 27, 28, 29], 
        				 ["5", "4", "3", "2", "1"],
                		 [1, 2, 3, 4, 5, 6, 2, 4, 5, 6, 3, 1, 4, 5, 2, 6, 3, 1, 5, 4, 2, 3, 1, 6, 6, 5, 4, 3, 2, 1, 3, 5, 6, 1, 4, 2])
                ];
var curQues = -1;
...
function openEndMenu(){
	...
	bonusText3.draw();
	bonusTextEnd.draw();
	for(var i in pieces){ // TODO: Loop from the bottom so we can account for ties
		pieces[i].x = 383+i*120; //i start at 0
		pieces[i].y = 418+(pieces[i].rank)*46;
		//pieces[i].y = 694;
		pieces[i].rankSign.arrowSrc = "CA1.png";
		pieces[i].rankSign.x = 383+i*120-8;
		pieces[i].rankSign.y = 418+(pieces[i].rank)*46+62+20;
		pieces[i].rankSign.arrowX = 383+i*120+21;
		pieces[i].rankSign.arrowY = 418+(pieces[i].rank)*46+62;
		pieces[i].rankSign.draw(pieces[i].rankSign);
	}
	drawPieces();
	context.textAlign="left";
}
...
$(document).ready(function() { dfsg dg  v
